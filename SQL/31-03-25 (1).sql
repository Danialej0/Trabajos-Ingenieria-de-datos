...
tipos:
	- de 1 columna: devuelve una lista de valores en una sola columna
    - varias columnas: multiples valores en varias columnas
    -correlacionales: depende de la consulta original.
    
    select camposConsultar from TABLA where (select camposConsulta from Tabla 2 where..)

*/

select * from producto;

# consulta el cliente que compro el mayor precio

SELECT * FROM Cliente 
WHERE cedulaCliente = (SELECT cedulaClienteFK FROM Producto
